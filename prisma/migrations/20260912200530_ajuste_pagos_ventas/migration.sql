-- Redirige las asignaciones de pago desde el detalle de venta a la venta raíz.
...
ALTER TABLE `asignaciones_pago`
  ADD CONSTRAINT `asignaciones_pago_id_venta_fkey`
