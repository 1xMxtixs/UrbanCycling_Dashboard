...
async function main() {
  ...
  const permisosData = [
    ...
    { nombre: "Ver proveedores", modulo: "proveedores", recurso: "proveedores", accion: "read", codigo: "suppliers:read", descripcion: "Permite consultar proveedores registrados" },
    { nombre: "Crear proveedores", modulo: "proveedores", recurso: "proveedores", accion: "create", codigo: "suppliers:create", descripcion: "Permite registrar proveedores" },
    { nombre: "Actualizar proveedores", modulo: "proveedores", recurso: "proveedores", accion: "update", codigo: "suppliers:update", descripcion: "Permite modificar proveedores" },
    { nombre: "Eliminar proveedores", modulo: "proveedores", recurso: "proveedores", accion: "delete", codigo: "suppliers:delete", descripcion: "Permite eliminar proveedores" },
