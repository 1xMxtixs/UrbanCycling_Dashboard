...
export function AssignSuppliesDialog({
  ...
  async function handleConfirmCancelOrder() {
    ...
    try {
      const res = await fetch(`/api/punto-venta/orden-${order!.idOrdenDeTrabajo}/estado`, {
        method: "PATCH",
        headers: {
            ...
            <div>
              {canEdit && (
                <Button
                  ...
                  className="gap-1.5 text-rose-600 hover:text-rose-700 hover:bg-rose-50 dark:hover:bg-rose-950/20 dark:text-rose-400 border-rose-200 dark:border-rose-900 cursor-pointer"
                >
      ...
      <Dialog open={showCancelConfirm} onOpenChange={setShowCancelConfirm}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>
              ¿Estás seguro de que deseas anular esta orden? Esta acción no se puede deshacer.
            </DialogDescription>
          </DialogHeader>
